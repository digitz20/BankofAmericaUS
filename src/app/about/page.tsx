                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <Card className="lg:col-span-2 overflow-hidden">
                            <Image src="https://placehold.co/800x400.png" data-ai-hint="downtown los angeles" alt="Downtown Los Angeles" width={800} height={400} className="w-full h-64 object-cover" />
                        ...
                        <Card className="flex flex-col overflow-hidden">
                            <Image src="https://placehold.co/400x300.png" data-ai-hint="woman making heart" alt="Woman making a heart shape with her hands" width={400} height={300} className="w-full h-48 object-cover" />
                ...
                <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-8">
                         <Card className="overflow-hidden">
                             <Image src="https://placehold.co/600x400.png" data-ai-hint="city skyline" alt="City skyline" width={600} height={400} className="w-full h-64 object-cover" />
                             <CardContent className="p-6">
                     ...
                     <div className="space-y-8">
                         <Card className="overflow-hidden">
                             <Image src="https://placehold.co/600x400.png" data-ai-hint="veterinarian puppy" alt="Veterinarian with a puppy" width={600} height={400} className="w-full h-64 object-cover" />
                             <CardContent className="p-6">

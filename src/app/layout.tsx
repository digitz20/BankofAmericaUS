    ...
    <html lang="en">
      ...
      <body className="font-body antialiased">
        <div className="bg-muted text-muted-foreground text-center py-2 text-sm font-medium">
          <p>Bank of America deposit products: <span className="text-lg font-bold text-primary">FDIC-Insured</span> - Backed by the full faith and credit of the U.S. Government</p>
        </div>
